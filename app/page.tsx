export default function Home() {
  ...
  const Badge = ({ label, color }: { label: string; color: string }) => (
    <span style={{ border: `1.5px solid ${color}`, color, fontFamily: "var(--font-barlow)", fontSize: 9, fontWeight: 700, letterSpacing: "0.2em", padding: "3px 8px", textTransform: "uppercase" as const }}>{label}</span>
  );
  ...
  return (
    <main style={{ fontFamily: "Georgia, serif", background: "#fff", color: "#1A1208", minHeight: "100vh" }}>
      ...
      <div style={{ textAlign: "center", padding: "24px 40px 0" }}>
        <div style={{ height: 3, background: "#1A1208", marginBottom: 3 }} />
        <div style={{ height: 1, background: "#1A1208", marginBottom: 14 }} />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, justifyContent: "center", margin: "14px 0 0" }}>
          ...
          <div style={{ fontSize: 12, fontWeight: 700, border: "1.5px solid #1A1208", borderRadius: "50%", width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center" }}>TdT</div>
          <div style={{ flex: 1, height: 1, background: "#1A1208", maxWidth: 220 }} />
        </div>
      </div>

      {/* NAV */}
      <nav style={{ display: "flex", justifyContent: "center", borderTop: "2px solid #1A1208", borderBottom: "1px solid #1A1208", marginTop: 14 }}>
        {[["Vols Desk","#FF6600"],["Titans Desk","#4B92DB"],["Film Room","#1A1208"],["Recruiting","#1A1208"],["Rocky Top","#1A1208"],["Newsletter","#1A1208"]].map(([label, color], i) => (
          <a key={i} href="#" style={{ fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase" as const, textDecoration: "none", color, padding: "9px 20px", borderRight: "1px solid #D4CEC7", borderLeft: i === 0 ? "1px solid #D4CEC7" : undefined }}>{label}</a>
        ))}
      </nav>
      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "0 40px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", borderBottom: "1px solid #D4CEC7", marginTop: 32, paddingBottom: 32 }}>
          <div style={{ paddingRight: 32, borderRight: "1px solid #D4CEC7" }}>
            ...
            <div style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "#8B7355" }}>By Staff Writer · May 19, 2026 · 4 min read</div>
          </div>
      ...
      {/* NEWSLETTER */}
      <div style={{ background: "#1A1208", color: "#fff", padding: "36px 40px", textAlign: "center", margin: "0 0 40px" }}>
      ...
      {/* FOOTER */}
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "0 40px" }}>
        <footer style={{ borderTop: "2px solid #1A1208", padding: "20px 0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
